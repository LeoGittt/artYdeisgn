...
export default function ContactSection() {
          ...
          if (entry.isIntersecting) {
            setTimeout(() => {
              ...
              entry.target.classList.remove(
                "opacity-0",
                entry.target.classList.contains("from-left")
                  ? "-translate-x-20"
                  : "translate-x-20"
              );
            }, index * 200);
  ...
  return (
    <section
      id="contacto"
      ref={sectionRef}
      className="w-full py-24 md:py-32 bg-beige relative"
    >
          ...
          >
            <Card className="bg-white rounded-xl shadow-soft border-none overflow-hidden h-full card-shadow-hover">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <h3 className="text-xl font-medium text-[#25D366] mb-3">
                  WhatsApp
                </h3>
                <p className="text-muted-foreground mb-6 flex-grow">
                  Contáctanos directamente por WhatsApp para una respuesta
                  rápida a tus consultas.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open("https://wa.me/542644568079", "_blank")
                    }
                  >
          ...
          >
            <Card className="bg-white rounded-xl shadow-soft border-none overflow-hidden h-full card-shadow-hover">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <p className="text-muted-foreground mb-6 flex-grow">
                  Envíanos un email con tus consultas, pedidos o solicitudes de
                  presupuesto.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "mailto:mueblitocodamuebles@gmail.com",
                        "_blank"
                      )
                    }
                  >
          ...
          >
            <Card className="bg-white rounded-xl shadow-soft border-none overflow-hidden h-full card-shadow-hover">
              <CardContent className="p-8 flex flex-col h-full">
                ...
                <h3 className="text-xl font-medium text-[#E1306C] mb-3">
                  Instagram
                </h3>
                <p className="text-muted-foreground mb-6 flex-grow">
                  Síguenos en Instagram para ver nuestras últimas creaciones y
                  novedades.
                </p>
                ...
                <div className="space-y-3">
                  ...
                  <Button
                    ...
                    onClick={() =>
                      window.open(
                        "https://www.instagram.com/mueblitocafe/",
                        "_blank"
                      )
                    }
                  >
